...
> This README is a **complete onboarding guide** for any new human developer or AI agent who has never seen the project before. It explains every folder, every key file, every function, data models, coordinate systems, pipelines, and how to extend the tool.
