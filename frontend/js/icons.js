 ...
 *
 * All new icons that replace emojis must live here so the visual language
 * stays consistent with the toolbar icons in text-formatting.js and
 * table-toolbar.js.
 */
(function (global) {
  const S = (d, extra) =>
  ...
  const AppIcons = {
     ...
     */
    get(name) {
      return icons[name] || S('<rect x="3" y="3" width="18" height="18" rx="2"/>');
    },
    /**
