...
window.__KEYBOARD_COMMANDS = [
    { id: 'save-page',           label: 'حفظ الصفحة',                          category: 'الصفحة',        defaultKey: 'Ctrl+S' },
    { id: 'prev-page',           label: 'الصفحة السابقة',                       category: 'الصفحة',        defaultKey: 'PageUp' },
    { id: 'next-page',           label: 'الصفحة التالية',                       category: 'الصفحة',        defaultKey: 'PageDown' },
    { id: 'load-ocr-page',       label: 'تحميل صفحة OCR',                       category: 'الصفحة',        defaultKey: 'Ctrl+O' },
    { id: 'open-fullpage',       label: 'عرض الصفحة بالحجم الكامل',              category: 'الصفحة',        defaultKey: 'Ctrl+Shift+F' },
    { id: 'toggle-sidebar',      label: 'إظهار/إخفاء الشريط الجانبي',            category: 'الصفحة',        defaultKey: 'Ctrl+Shift+B' },
    { id: 'project-settings',    label: 'إعدادات المشروع',                       category: 'الصفحة',        defaultKey: 'Ctrl+Shift+S' },

    { id: 'undo',                label: 'تراجع',                                category: 'التراجع والإعادة', defaultKey: 'Ctrl+Z' },
    { id: 'redo',                label: 'إعادة',                                category: 'التراجع والإعادة', defaultKey: 'Ctrl+Y' },

    { id: 'export',              label: 'تصدير المشروع',                        category: 'أدوات',          defaultKey: 'Ctrl+E' },
    { id: 'text-preview',        label: 'معاينة النص الكامل',                    category: 'أدوات',          defaultKey: 'Ctrl+P' },
    { id: 'dashboard',           label: 'لوحة التقدم',                           category: 'أدوات',          defaultKey: 'Ctrl+Shift+D' },

    { id: 'delete-block',        label: 'حذف الكتلة المحددة',                    category: 'الكتلة النصية',   defaultKey: 'Ctrl+Delete' },
    { id: 'toggle-reviewed',     label: 'تبديل حالة المراجعة للكتلة المحددة',    category: 'الكتلة النصية',   defaultKey: 'Ctrl+Shift+M' },
    { id: 'block-font-increase', label: 'تكبير حجم عرض النص',                    category: 'الكتلة النصية',   defaultKey: 'Ctrl+=' },
    { id: 'block-font-decrease', label: 'تصغير حجم عرض النص',                    category: 'الكتلة النصية',   defaultKey: 'Ctrl+-' },
    { id: 'block-font-reset',    label: 'إعادة ضبط حجم عرض النص',                category: 'الكتلة النصية',   defaultKey: 'Ctrl+0' },

    { id: 'crop-zoom-in',        label: 'تكبير الاقتطاع',                        category: 'الاقتطاع',       defaultKey: 'Alt+=' },
    { id: 'crop-zoom-out',       label: 'تصغير الاقتطاع',                        category: 'الاقتطاع',       defaultKey: 'Alt+-' },
    { id: 'crop-zoom-reset',     label: 'إعادة ضبط تكبير الاقتطاع',              category: 'الاقتطاع',       defaultKey: 'Alt+0' },

    { id: 'fmt-bold',            label: 'غامق',                                 category: 'تنسيق النص',     defaultKey: 'Ctrl+B' },
    { id: 'fmt-italic',          label: 'مائل',                                 category: 'تنسيق النص',     defaultKey: 'Ctrl+I' },
    { id: 'fmt-underline',       label: 'تسطير',                                category: 'تنسيق النص',     defaultKey: 'Ctrl+U' },
    { id: 'fmt-strike',          label: 'يتوسطه خط',                            category: 'تنسيق النص',     defaultKey: 'Ctrl+Shift+X' },
    { id: 'fmt-superscript',     label: 'نص علوي',                              category: 'تنسيق النص',     defaultKey: 'Ctrl+.' },
    { id: 'fmt-subscript',       label: 'نص سفلي',                              category: 'تنسيق النص',     defaultKey: 'Ctrl+,' },
    { id: 'fmt-remove',          label: 'فرشاة إزالة التنسيق',                   category: 'تنسيق النص',     defaultKey: 'Ctrl+Shift+N' },
    { id: 'brush-tashkeel',      label: 'فرشاة إزالة التشكيل',                   category: 'تنسيق النص',     defaultKey: 'Ctrl+Shift+T' },
    { id: 'brush-format',        label: 'فرشاة نسخ التنسيق',                     category: 'تنسيق النص',     defaultKey: 'Ctrl+Shift+C' },

    { id: 'align-right',         label: 'محاذاة لليمين',                        category: 'محاذاة الكتلة',   defaultKey: 'Ctrl+Shift+R' },
    { id: 'align-left',          label: 'محاذاة لليسار',                        category: 'محاذاة الكتلة',   defaultKey: 'Ctrl+Shift+L' },
    { id: 'align-center',        label: 'محاذاة للوسط',                         category: 'محاذاة الكتلة',   defaultKey: 'Ctrl+Shift+E' },
    { id: 'align-justify',       label: 'ضبط (محاذاة الطرفين)',                  category: 'محاذاة الكتلة',   defaultKey: 'Ctrl+Shift+J' },
    { id: 'dir-rtl',             label: 'اتجاه النص: من اليمين لليسار',          category: 'محاذاة الكتلة',   defaultKey: 'Ctrl+Shift+9' },
    { id: 'dir-ltr',             label: 'اتجاه النص: من اليسار لليمين',          category: 'محاذاة الكتلة',   defaultKey: 'Ctrl+Shift+0' },

    { id: 'focus-next-block',    label: 'الانتقال للكتلة التالية (حفظ تلقائي)', category: 'الكتلة النصية',   defaultKey: 'Tab' },
    { id: 'focus-prev-block',    label: 'الانتقال للكتلة السابقة (حفظ تلقائي)', category: 'الكتلة النصية',   defaultKey: 'Shift+Tab' },
